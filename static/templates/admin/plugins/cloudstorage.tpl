<div class="py-5">
  <div class="container">
    <div class="row">
              ...
              <div class="col-md-12">
                <div class="card mb-3">
                  <div class="card-header">
                    <img class="img-fluid" src="{../logo}" alt="{@key}" style="max-width:100px;">
                  </div>
                  <div class="card-body">
                    ...
                    <input type="password" class="form-control" name="{@key}-token" placeholder="Enter your GitHub Personal Access Token" autocomplete="off">
      ...
      <div class="col-md-6">
        <h4>Help</h4>
        <iframe id="update-frame" frameborder="0" scrolling="no" 
                src="https://june07.github.io/nodebb-plugin-cloudstorage/help" class="w-100" style="height:600px;"></iframe>
      </div>
    </div>
  </div>

  <!-- Save Floating Button -->
  <button id="save" class="btn btn-primary btn-lg rounded-circle position-fixed bottom-0 end-0 m-4">
