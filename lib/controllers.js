    ...
    providersUpload: function(image, fileObject, callback) {
      ...
      switch (settings.activeProvider) {
        case 'cloudinary':
          ...
          .catch(error => {
            debug(`Error in function providersUpload() cloudinary: ${error}`);
            let message = error;
        ...
        case 'imagekit':
          ...
          .catch(error => {
            debug(`Error in function providersUpload() imagekit: ${error}`);
        ...
        case 'awss3':
          ...
          .catch(error => {
            debug(`Error in function providersUpload() awss3: ${error}`);
            callback(new Error(error));
          }); break;
      }
    },
